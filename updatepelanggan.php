...
$query = mysqli_query($con, "select * from pelanggan where id_pelanggan = '".$id."'");
          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <form class="form-sample" method="POST" action="controller/updatepelanggan.php">
                <input type="hidden" name="idpelanggan" class="form-control" value="<?php echo $result['id_pelanggan'];?>" readonly/>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Nama Pelanggan</label>
                        <div class="col-sm-9">
                            <input type="text" name="nama" class="form-control" value="<?php echo $result['nama_pelanggan'];?>" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="nomorkwh" class="form-control" value="<?php echo $result['nomor_kwh'];?>" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <option class="dropdown-item" value="">Select Tarif & Daya</option>
                          <?php
                                ...
                                <option class="dropdown-item" value="<?php echo $data['id_tarif']?>"  <?php echo ($data['id_tarif'] ==  $result['id_tarif']) ? ' selected="selected"' : '';?>><?php echo $data['tarifperkwh']?> - <?php echo $data['daya']?></option>
                            <?php } ?>
                          </select>
                                    </div>
                      </div>
